...
![GitHub Actions Static Website Deployment](assets/screenshots/github-actions-static-success.png)

### GitHub Actions — Azure Function Deployment

![GitHub Actions Azure Function Deployment](assets/screenshots/github-actions-function-success.png)

### Azure Function

![Azure Function](assets/screenshots/azure-function.png)

### Azure Function App

![Azure Function App](assets/screenshots/azure-function-app.png)

### Azure Storage Account

![Azure Storage Account](assets/screenshots/azure-storage-account.png)

### Azure Table Storage

![Azure Table Storage](assets/screenshots/azure-table-storage.png)

### Azure Static Website

![Azure Static Website](assets/screenshots/azure-static-website.png)
